# telos-runner-executor-role setup

Companion to the telos-runner-dispatcher Lambda (nousergon-data). Two-step
...
```sh
aws iam create-role --role-name telos-runner-executor-role \
  --assume-role-policy-document file://infrastructure/iam/telos-runner-executor-role-trust.json
aws iam put-role-policy --role-name telos-runner-executor-role \
  --policy-name telos-runner-executor-policy \
  --policy-document file://infrastructure/iam/telos-runner-executor-role-policy.json
aws iam create-instance-profile --instance-profile-name telos-runner-executor-profile
aws iam add-role-to-instance-profile --instance-profile-name telos-runner-executor-profile \
  --role-name telos-runner-executor-role
...
aws iam attach-role-policy --role-name telos-runner-executor-role \
